...
export default function DeliveryLabel() {
  ...
  if (isLoading) {
    return (
      <div style={{ background: "#163524", minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  if (isError || !data) {
    return (
      <div style={{ background: "#163524", minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
  ...
  return (
    <>
      ...
      <div className="screen-only" style={{ minHeight: "100dvh", background: "linear-gradient(180deg, #1C3D2C 0%, #163524 100%)", padding: "24px 16px 60px", fontFamily: "Montserrat, sans-serif", color: "#F1E9D6" }}>
