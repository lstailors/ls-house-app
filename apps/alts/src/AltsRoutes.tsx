...
const HomeTiles = lazy(() => import("@alts/pages/HomeTiles"));
const IntakeStepped = lazy(() => import("@alts/pages/IntakeStepped"));
const TicketKind = lazy(() => import("@alts/pages/TicketKind"));
const ShopFloorBoard = lazy(() => import("@alts/pages/ShopFloorBoard"));
const PickupCounter = lazy(() => import("@alts/pages/PickupCounter"));
const ParkedTray = lazy(() => import("@alts/pages/ParkedTray"));
const Transfers = lazy(() => import("@alts/pages/Transfers"));
const OrdersGlass = lazy(() => import("@alts/pages/OrdersGlass"));
const Lookup = lazy(() => import("@alts/pages/Lookup"));
const ProgressBoard = lazy(() => import("@alts/pages/ProgressBoard"));
const TicketPhotos = lazy(() => import("@alts/pages/TicketPhotos"));
const Dispatch = lazy(() => import("@alts/pages/Dispatch"));
const QuoteComposer = lazy(() => import("@alts/pages/QuoteComposer"));
const AppointmentsGlass = lazy(() => import("@alts/pages/AppointmentsGlass"));
const TasksGlass = lazy(() => import("@alts/pages/TasksGlass"));
const MessagesGlass = lazy(() => import("@alts/pages/MessagesGlass"));
const HouseFind = lazy(() => import("@alts/pages/HouseFind"));
const QcGlass = lazy(() => import("@alts/pages/QcGlass"));
const QcInspection = lazy(() => import("@alts/pages/QcInspection"));
const AltsSettings = lazy(() => import("@alts/pages/AltsSettings"));
const TicketDetail = lazy(() => import("@alts/pages/intake/TicketDetail"));
