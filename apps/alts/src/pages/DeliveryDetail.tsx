...
import { useUpdateDelivery, useCustomerSearch, useDeliveryProofUrls } from "@alts/lib/queries";
...
import { DeliveryPinMap } from "@alts/components/maps/DeliveryPinMap";
import { AiInsightsCard } from "@alts/components/deliveries/AiInsightsCard";
import { GenerateMessageDialog } from "@alts/components/deliveries/GenerateMessageDialog";
    ...
    <div className="space-y-5 animate-fade-up max-w-2xl mx-auto pb-10">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          {delivery.orderRef ? (
            <Link
              to={`/admin/sales-orders/${encodeURIComponent(delivery.orderRef)}`}
