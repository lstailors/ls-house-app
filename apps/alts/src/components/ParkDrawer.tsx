        ...
        <div className="px-6 md:px-[30px] pb-5">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[12px] text-[var(--cd)] mt-1.5 leading-relaxed">
          ...
          <div className="grid md:grid-cols-[1.25fr_1fr] gap-4">
            <div className="space-y-3">
              <div className="card-glass overflow-hidden">
                <div className="flex items-center gap-2.5 px-[17px] py-3 border-b border-brass/15 bg-black/20">
                  ...
                  <span className="text-[12px] font-bold tracking-widest uppercase text-[var(--am)]">Required</span>
                </div>
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {CHIPS.map((c) => (
                      <button
                        ...
                        type="button"
                        onClick={() => applyChip(c)}
                        className="px-3.5 py-2 rounded-[10px] bg-black/30 border border-brass/25 text-[12px] font-semibold text-[var(--cm)] hover:bg-[rgba(232,168,92,0.14)] hover:border-[rgba(232,168,92,0.44)] hover:text-cream"
                      >
                        + {c}
                      </button>
                    ))}
                  ...
                  {!labelOk && (
                    <div className="flex gap-2.5 p-3 rounded-xl bg-[rgba(217,123,108,0.1)] border border-[rgba(217,123,108,0.38)] text-[12px] leading-relaxed text-[var(--cm)]">
              ...
              <div className="card-glass overflow-hidden">
                ...
                <div className="flex items-baseline justify-between px-[17px] py-3.5 bg-black/25 border-t border-brass/15">
                  <span className="text-[12px] font-bold tracking-widest uppercase text-[var(--cd)]">
            ...
            <div className="space-y-3">
              <div className="rounded-[15px] p-4 bg-[rgba(232,168,92,0.09)] border border-[rgba(232,168,92,0.38)]">
                ...
                <p className="text-[12px] text-[var(--cm)] leading-relaxed">
                ...
                <div className="flex items-center gap-2.5 mt-3">
                  <span className="flex-1 text-[12px] font-bold tracking-widest uppercase text-[var(--cd)]">Garments expected</span>
                ...
                <div className="flex gap-1 p-1 rounded-xl bg-black/30 border border-brass/20">
                  {(
                    ...
                    <button
                      ...
                      className={cn(
                        "flex-1 min-h-[50px] rounded-[9px] text-[12px] font-bold tracking-wide uppercase flex flex-col items-center justify-center gap-0.5",
                        remind === k ? "bg-[var(--am)] text-[#1C1204]" : "text-[var(--cd)]",
                      )}
                    >
                      {lab}
                      {hint ? <i className="not-italic text-[12px] font-semibold opacity-70 normal-case">{hint}</i> : null}
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-4">
            ...
            >
              ...
              <i className="not-italic text-[12px] tracking-widest opacity-75 font-semibold">
            ...
            >
              ...
              <i className="not-italic text-[12px] tracking-widest opacity-75 font-semibold">Creates ticket · burns a number</i>
            </button>
          </div>

          <div className="mt-3 p-3 rounded-xl bg-brass/[0.07] border border-brass/20 text-[12px] leading-relaxed text-[var(--cm)]">
            <b className="block text-[12px] font-bold tracking-widest uppercase text-brass-light mb-1.5">What parking writes</b>
            One <code className="text-brass-light font-mono text-[12px]">LSH Parked Cart</code> holding cart JSON —{" "}
